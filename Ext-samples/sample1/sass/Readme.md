...
folder are mapped to the application's root namespace, 'sample1'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'sample1' in the same way
as `"sample1/sass/src"`.
